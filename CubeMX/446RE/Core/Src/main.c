...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, Output_0_Pin|Z_STEP_Pin|Output_1_Pin|Output_2_Pin
                          |Z_DIR_Pin|Output_3_Pin|Output_4_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : Output_0_Pin Z_STEP_Pin Output_1_Pin Output_2_Pin
                           Z_DIR_Pin Output_3_Pin Output_4_Pin */
  GPIO_InitStruct.Pin = Output_0_Pin|Z_STEP_Pin|Output_1_Pin|Output_2_Pin
                          |Z_DIR_Pin|Output_3_Pin|Output_4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
